...
class NL_Checkout 
{
	...
	public $nganluong_url = 'https://nganluong.vn/checkout.php';	
	// Mã website của bạn đăng ký trong chức năng tích hợp thanh toán của NgânLượng.vn.
	public $merchant_site_code = '65609'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	public $secure_pass= 'bf6b058510d16bb7011a6f19c4cdf4bc'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
